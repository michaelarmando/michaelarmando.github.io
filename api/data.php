...
I actively engage in real-world projects and volunteer programs to sharpen my collaboration, adaptability, and problem-solving skills. Passionate about connecting technology and business, I aim to deliver impactful IT solutions and grow as a technology-driven problem solver.',
    ...
    'cv_url' => 'CV-Michael-Armando-Putra.pdf', 
    'social_links' => [ 
...
$portfolioItems = [
    ...
    [
        ...
        'description' => 'Developed a simple application for efficient and integrated heavy equipment rental management.',
    ...
    [
        ...
        'description' => 'Graduated from the Social Sciences program at SMAK Penabur Harapan Indah.',
        'link' => ''
    ],
    [
        ...
        'description' => "Currently pursuing a Bachelor's degree in Business Information Technology.",
        'link' => ''
    ],
    [
        'title' => 'Tutor Terbaik',
        ...
        'description' => 'Awarded in recognition of outstanding achievement as the Best Tutor during the 2021/2022 academic year at SMAK Penabur Harapan Indah.',
        'link' => '' 
    ],
    [
        ...
        'description' => 'Award for participation in Spirituality, Beliefs, and Ethics subject during the 2022/2023 academic year.',
        'link' => '' 
    ],
    [
        ...
        'description' => 'Completed the ENGLISH FOR CREATIVE WRITING program at Beelingua',
        'link' => '' 
    ],
    [
        ...
        'description' => 'Completed the ENGLISH FOR PROFESSIONAL OFFICE program at Beelingua.',
        'link' => '' 
    ],
    [
        ...
        'description' => 'Completed the ADVANCED ENGLISH (CEFR C2.1) program at Beelingua',
        'link' => '' 
    ],
    [
        ...
        'description' => 'Completed the MARKET RESEARCH & BUSINESS COMMUNICATION (CEFR C2.2) program at Beelingua.',
        'link' => '' 
    ],
    [
        ...
        'description' => 'Completed the ENGLISH INDEPENDENT USER (CEFR B) program at Beelingua.',
        'link' => '' 
    ],
    [
